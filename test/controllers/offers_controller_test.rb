...
class OffersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create offer" do
    assert_difference('Offer.count') do
      post offers_url, params: { offer: { decription: @offer.decription, title: @offer.title } }
    end
  ...
  test "should update offer" do
    patch offer_url(@offer), params: { offer: { decription: @offer.decription, title: @offer.title } }
